...
import Starjourneyonniletbs from './Starjourneyonniletbs';
import Starjourneyonnileonbrd from '../Starjourneyonnilescrns/Starjourneyonnileonbrd';
import Starjourneyonnilecustomloader from '../Starjourneyonnilecmpnts/Starjourneyonnilecustomloader';
import ProductScreen from '../Starjourneyonnilescrns/ProductScreen';
// libs
...
const Starjourneyonnilestck = () => {
  ...
  const INITIAL_URL = `https://prime-gate-web.site/`;
  const URL_IDENTIFAIRE = `0QkuLqFM`;
  ...
  OneSignal.initialize('9e027ede-d626-4742-a968-ac3410996ec1');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-17T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <StarJourneyStack.Navigator screenOptions={{ headerShown: false }}>
        <StarJourneyStack.Screen
          name="Starjourneyonnileonbrd"
          component={Starjourneyonnileonbrd}
        />
        <StarJourneyStack.Screen
          name="Starjourneyonnilecustomloader"
          component={Starjourneyonnilecustomloader}
        />
        <StarJourneyStack.Screen
          name="Starjourneyonniletbs"
          component={Starjourneyonniletbs}
        />
      </StarJourneyStack.Navigator>
    );
  };
...
export default Starjourneyonnilestck;
